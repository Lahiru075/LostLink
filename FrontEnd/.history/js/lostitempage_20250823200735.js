<script>
    // Use jQuery's document ready function to ensure the DOM is loaded
    $(document).ready(function() {
        ...
        const $suggestionsPanel = $('<div>').addClass('suggestions-panel');
        $searchInput.after($suggestionsPanel);
        ...
        // Function to fetch suggestions (using jQuery's $.ajax)
        ...
        function displaySuggestions(suggestions) {
            ...
            $suggestionsPanel.empty(); // Clear old suggestions
